...
<html lang="en">
    ...
    <head>
       ...
       @include('admin.common.header_scripts')
    </head>
    ...
    <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
       ...
       @include('admin.common.header_mobile')
        ...
        {{-- <div id="kt_quick_panel" class="kt-offcanvas-panel">
            <div class="kt-offcanvas-panel__nav">
                ...
                <button class="kt-offcanvas-panel__close" id="kt_quick_panel_close_btn"><i
                    ...
                    <div class="tab-pane fade show kt-offcanvas-panel__content kt-scroll active"
                        ...
                        <div class="kt-timeline">
                            ...
                            <div class="kt-timeline__item kt-timeline__item--warning">
                                ...
                                <a href="" class="kt-timeline__item-text">
                                    Meeting with Ken Digital Corp ot Unit14, 3 Edigor Buildings, George Street,
                        ...
                        <div class="kt-portlet kt-portlet--solid-success">
                            <div class="kt-portlet__head">
                                <div class="kt-portlet__head-label">
                                    <span class="kt-portlet__head-icon kt-hide"><i
                            ...
                            <div class="kt-portlet__body">
                                <div class="kt-portlet__content">
                                    Lorem Ipsum is simply dummy text of the printing and typesetting simply dummy text
        ...
        {{-- <ul class="kt-sticky-toolbar" style="margin-top: 30px;">
            ...
            <li class="kt-sticky-toolbar__item kt-sticky-toolbar__item--builder" data-toggle="kt-tooltip"
                ...
                <a href="https://keenthemes.com/keen/preview/demo1/builder.html" target="_blank"><i
                        class="flaticon2-box"></i></a>
            </li>
            ...
            <div class="kt-demo-panel__body">
                <div class="kt-demo-panel__item kt-demo-panel__item--active">
                    ...
                    <div class="kt-demo-panel__item-preview">
                        ...
                        <div class="kt-demo-panel__item-preview-overlay">
                            <a href="https://keenthemes.com/keen/preview/demo1/" class="btn btn-brand btn-elevate "
                                target="_blank">Default</a>
                            <a href="https://keenthemes.com/keen/preview/demo1/rtl/" class="btn btn-light btn-elevate"
                ...
                <div class="kt-demo-panel__item ">
                    ...
                    <div class="kt-demo-panel__item-preview">
                        ...
                        <div class="kt-demo-panel__item-preview-overlay">
                            <a href="https://keenthemes.com/keen/preview/demo2/" class="btn btn-brand btn-elevate "
                                target="_blank">Default</a>
                            <a href="https://keenthemes.com/keen/preview/demo2/rtl/" class="btn btn-light btn-elevate"
                                target="_blank">RTL Version</a>
                        </div>
                    </div>
                </div>
                <div class="kt-demo-panel__item ">
                    ...
                    <div class="kt-demo-panel__item-preview">
                        ...
                        <div class="kt-demo-panel__item-preview-overlay">
                            <a href="https://keenthemes.com/keen/preview/demo3/" class="btn btn-brand btn-elevate "
                                target="_blank">Default</a>
                            <a href="https://keenthemes.com/keen/preview/demo3/rtl/" class="btn btn-light btn-elevate"
                                target="_blank">RTL Version</a>
                        </div>
                    </div>
                </div>
                <div class="kt-demo-panel__item ">
                    ...
                    <div class="kt-demo-panel__item-preview">
                        ...
                        <div class="kt-demo-panel__item-preview-overlay">
                            <a href="https://keenthemes.com/keen/preview/demo4/" class="btn btn-brand btn-elevate "
                                target="_blank">Default</a>
                            <a href="https://keenthemes.com/keen/preview/demo4/rtl/" class="btn btn-light btn-elevate"
                                target="_blank">RTL Version</a>
                        </div>
                    </div>
                </div>
                <div class="kt-demo-panel__item ">
                    ...
                    <div class="kt-demo-panel__item-preview">
                        ...
                        <div class="kt-demo-panel__item-preview-overlay">
                            <a href="https://keenthemes.com/keen/preview/demo5/" class="btn btn-brand btn-elevate "
                                target="_blank">Default</a>
                            <a href="https://keenthemes.com/keen/preview/demo5/rtl/" class="btn btn-light btn-elevate"
                                target="_blank">RTL Version</a>
                        </div>
                    </div>
                </div>
                <div class="kt-demo-panel__item ">
                    ...
                    <div class="kt-demo-panel__item-preview">
                        ...
                        <div class="kt-demo-panel__item-preview-overlay">
                            <a href="https://keenthemes.com/keen/preview/demo6/" class="btn btn-brand btn-elevate "
                                target="_blank">Default</a>
                            <a href="https://keenthemes.com/keen/preview/demo6/rtl/" class="btn btn-light btn-elevate"
                                target="_blank">RTL Version</a>
                        </div>
                    </div>
                </div>
                ...
                <a href="https://themes.getbootstrap.com/product/keen-the-ultimate-bootstrap-admin-theme/"
                    target="_blank" class="kt-demo-panel__purchase btn btn-brand btn-elevate btn-bold btn-upper">
                    Buy Keen Now!
                </a>
            </div>
        </div> --}}
      ...
      @include('admin.common.footer_scripts')
    </body>
