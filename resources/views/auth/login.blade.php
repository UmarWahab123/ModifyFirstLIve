...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('admin/assets/css/pages/login/login-v2.css')}}" rel="stylesheet" type="text/css" />
                ...
                <div class="kt-grid__item  kt-grid--hor">
                    ...
                    <div class="kt-login-v2__head">
                        <div class="kt-login-v2__logo">
                            <a href="#">
                                <img src="{{asset('admin/assets/media/logos/logo-5.png')}}" alt="" />
                            </a>
                        </div>
                    ...
                    <div class="kt-login-v2__body">
                        ...
                        <div class="kt-login-v2__wrapper">
                            <div class="kt-login-v2__container">
                                ...
                                <!--begin::Form-->
                                <form class="kt-login-v2__form kt-form" action="{{url('admin/login')}}" autocomplete="off" id="kt_login_form" method="POST">
                                    @csrf
                        ...
                        <div class="kt-login-v2__image">
                            <img src="{{asset('admin/assets/media/misc/bg_icon.svg')}}" alt="">
                        </div>
